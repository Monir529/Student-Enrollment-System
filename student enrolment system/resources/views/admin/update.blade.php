...
<div class="col-12 col-lg-6 grid-margin">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form class="forms-sample" action="{{URL('/update/'.$student->student_id)}}" method="post" enctype="multipart/form-data">
                          {{ csrf_field() }}
                              <div class="form-group row">
                                  <label for="exampleInputEmail2" class="col-sm-4 col-form-label">Student Name</label>
                                  <div class="col-sm-8">
                                    <input type="text" value="{{($student->student_name)}}" name="student_name" class="form-control p-input" id="exampleInputEmail2" aria-describedby="emailHelp2" placeholder="Enter Name">
                                    @error('student_name')
              ...
              @enderror 
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" value="{{($student->student_roll)}}" name="student_roll" class="form-control p-input" id="exampleInputPassword2" placeholder="Student Roll">
                                    @error('student_roll')
              <span style="color:red"><div class="error">{{ $message }}</div></span>
              @enderror 
                                  </div>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" value="{{($student->father_name)}}" name="father_name"class="form-control p-input" id="exampleInputEmail2" aria-describedby="emailHelp2" placeholder="Father Name">
                                    @error('father_name')
              <span style="color:red"><div class="error">{{ $message }}</div></span>
              @enderror 
                                  </div>
                              ...
                              <div class="form-group row">
                                  ...
                                  <input type="text" value="{{($student->mother_name)}}" name="mother_name"class="form-control p-input" id="exampleInputEmail2" aria-describedby="emailHelp2" placeholder="Mother Name">
                                  @error('mother_name')
              <span style="color:red"><div class="error">{{ $message }}</div></span>
              @enderror 
                                  </div>
              ...
              @enderror 
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="date" value="{{($student->admission_year)}}"  name="admission_year"class="form-control p-input" id="exampleInputEmail2" aria-describedby="emailHelp2" placeholder="Admission Year">
